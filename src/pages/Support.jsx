  ...
  return (
    <section className="py-24 bg-white">
      <div className="container mx-auto px-6 max-w-2xl">
        <h1 className="text-4xl font-black text-[#0B1E3B] mb-8">Support</h1>
        ...
        <p className="text-slate-500">For more information, please contact <a href="mailto:info@undayouth.org" className="text-[#00C2CB] font-bold hover:underline">info@undayouth.org</a></p>
      </div>
    </section>
  );
};
