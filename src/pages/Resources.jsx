          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="max-w-4xl">
              <h1 className="text-6xl lg:text-8xl font-black text-white leading-[0.9] tracking-tighter mb-8">
                Resources & <span className="text-unda-yellow">Tools.</span>
              </h1>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-3 mb-8">
                <div className="h-12 w-12 rounded-2xl bg-unda-orange/10 flex items-center justify-center">
                  <Heart size={24} className="text-unda-orange" />
                </div>
                <h2 className="text-4xl font-black text-unda-navy">Youth Stories</h2>
              </div>
              
              <div className="bg-white rounded-2xl p-8 border border-slate-100 shadow-lg">
                <h3 className="text-2xl font-black text-unda-navy mb-3">Storytelling Content</h3>
                <p className="text-slate-600 leading-relaxed mb-6">
        ...
        <section className="py-24 bg-unda-navy text-white">
          <div className="container mx-auto px-6 text-center">
            <h2 className="text-5xl font-black mb-6">
              Looking for <span className="text-unda-yellow">More Resources?</span>
            </h2>
            ...
            <Button className="h-14 px-8 rounded-2xl bg-unda-yellow text-unda-navy hover:bg-unda-orange hover:text-white text-lg font-bold">
