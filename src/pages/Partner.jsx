                ...
                <div className="space-y-6">
                  {[
                    ...
                    { title: "Innovation", desc: "Support cutting-edge peer-led and digital mental health solutions." }
                      ...
                      <div>
                        <h4 className="font-bold text-[#0B1E3B] text-lg">{item.title}</h4>
                ...
                {!submitted ? (
                  <form onSubmit={handleSubmit} className="relative z-10 space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-sm font-bold text-[#0B1E3B] uppercase tracking-wider">Contact Person</label>
                        <Input 
                          name="contactPerson"
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-bold text-[#0B1E3B] uppercase tracking-wider">Email Address</label>
                        <Input 
                          name="email"
                          type="email"
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-[#0B1E3B] uppercase tracking-wider">Partnership Type</label>
                      <select 
                    ...
                    <div className="space-y-2">
                       <label className="text-sm font-bold text-[#0B1E3B] uppercase tracking-wider">Message / Proposal</label>
                       <textarea
                          name="message"
