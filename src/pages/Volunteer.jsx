          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="max-w-4xl">
              <h1 className="text-6xl lg:text-8xl font-black text-white leading-[0.9] tracking-tighter mb-8">
                Join the <span className="text-unda-yellow">Movement.</span>
              </h1>
          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div className="space-y-12">
                <div>
                  <h2 className="text-4xl font-black text-unda-navy mb-6 font-unda">Why Get Involved?</h2>
                ...
                <div className="space-y-4">
                  <button
                    ...
                    className={`w-full text-left p-6 rounded-2xl border-2 transition-all ${
                      formType === 'volunteer' 
                        ? 'border-unda-orange bg-unda-orange/5 shadow-lg' 
                        : 'border-slate-100 hover:border-unda-orange/30'
                    }`}
                  >
                    <div className="flex items-start gap-4">
                      <div className={`p-3 rounded-xl ${formType === 'volunteer' ? 'bg-unda-orange text-white' : 'bg-slate-100 text-unda-orange'}`}>
                        <Users size={24} />
                      </div>
                      <div>
                        <h4 className="font-bold text-unda-navy text-lg mb-2">I Want to Volunteer</h4>
                  ...
                  <button
                    ...
                    className={`w-full text-left p-6 rounded-2xl border-2 transition-all ${
                      formType === 'host-event' 
                        ? 'border-unda-yellow bg-unda-yellow/5 shadow-lg' 
                        : 'border-slate-100 hover:border-unda-yellow/30'
                    }`}
                  >
                    <div className="flex items-start gap-4">
                      <div className={`p-3 rounded-xl ${formType === 'host-event' ? 'bg-unda-yellow text-white' : 'bg-slate-100 text-unda-yellow'}`}>
                        <Calendar size={24} />
                      </div>
                      <div>
                        <h4 className="font-bold text-unda-navy text-lg mb-2">I Want to Host an Event</h4>
                        <p className="text-sm text-slate-600">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={idx} className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-unda-navy">{item.title}</h4>
              ...
              {/* Right Column: Form */}
              <div className="bg-unda-bg/50 rounded-[2.5rem] p-8 lg:p-12 border border-slate-100 shadow-xl relative overflow-hidden flex flex-col justify-center min-h-[600px]">
                {!formType ? (
                   <div className="text-center space-y-6 animate-in fade-in zoom-in duration-500">
                      <div className="mx-auto w-24 h-24 bg-unda-teal/10 rounded-full flex items-center justify-center mb-4">
                        <Sparkles size={40} className="text-unda-teal" />
                      </div>
                      <h3 className="text-3xl font-black text-unda-navy">Let's Get Started!</h3>
                  ...
                  <form onSubmit={handleSubmit} className="relative z-10 space-y-6 animate-in slide-in-from-right-10 duration-500">
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-2xl font-black text-unda-navy">
                        {formType === 'volunteer' ? 'Volunteer Sign-Up' : 'Event Hosting Request'}
                      </h3>
                      <button 
                        type="button" 
                        onClick={() => setFormType(null)}
                        className="text-xs font-bold text-slate-400 hover:text-unda-navy uppercase tracking-wider"
                      >
                        Change Selection
                      </button>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-bold text-unda-navy uppercase tracking-wider">Phone</label>
                        <Input 
                          name="phone"
                          type="tel"
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-unda-navy uppercase tracking-wider">
                    ...
                    <Button 
                      type="submit" 
                      className={`w-full h-14 ${formType === 'volunteer' ? 'bg-unda-orange hover:bg-unda-orange/90' : 'bg-unda-yellow hover:bg-unda-yellow/90'} text-white font-bold text-lg rounded-xl shadow-lg transition-all`}
                    >
