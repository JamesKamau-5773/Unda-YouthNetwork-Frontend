  ...
  return (
    <Layout>
      <div className="min-h-screen bg-transparent">
        {/* Hero Section */}
        <section className="pt-40 pb-20 bg-gradient-to-br from-unda-yellow via-unda-orange to-unda-teal relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="max-w-4xl">
              <h1 className="text-6xl lg:text-8xl font-black text-white leading-[0.9] tracking-tighter mb-8">
                Gallery & <span className="text-unda-navy">Moments.</span>
              </h1>
        ...
        <section className="py-24 bg-unda-navy text-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <Link to="/membership" className="inline-flex items-center h-14 px-8 rounded-2xl bg-unda-yellow text-unda-navy hover:bg-unda-orange hover:text-white text-lg font-bold transition-colors">
              Get Involved
            </Link>
          </div>
        </section>
