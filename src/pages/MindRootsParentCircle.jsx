        ...
        <section className="pt-40 pb-20 bg-gradient-to-br from-[#0B1E3B] to-[#00C2CB] relative overflow-hidden hero-overlay">
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="max-w-4xl text-center mx-auto">
              ...
              <p className="text-xl text-slate-200 leading-relaxed max-w-3xl mx-auto mb-6">A prevention-focused support community for immigrant parents raising teens and young adults across cultures.</p>
