...
const PreventionPackage = () => {
  const steps = [
    {id: "01", title: "Initial Screening", desc: "PHQ-9 and GAD-7 tools to identify baseline needs"},
    {id: "02", title: "Daily Affirmations", desc: "Daily affirmations for positive mental habits and emotional regulation."},
    {id: "03", title: "Weekly Peer Check-Ins", desc: "Weekly peer check-ins for social connectedness and Psychological First Aid; includes referrals to community resources."},
    ...
    <section className = "py-32 bg-[#F9FAFB]/50">
      <div className = "container mx-auto px-6">
        <div className = "max-w-3xl mx-auto text-center mb-20">
          <h2 className = "text-4xl font-black text-[#0B1E3B] mb-4">Unda Mind Vibes (UMV) Prevention Package</h2>
