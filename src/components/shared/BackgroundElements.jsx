...
const BackgroundElements = () => {
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-[#00C2CB]/5 blur-[120px] animate-pulse" />
      <div className="absolute bottom-[10%] right-[-5%] w-[40%] h-[40%] rounded-full bg-[#00C2CB]/5 blur-[100px]" />
      <div className="absolute top-[40%] left-[30%] w-[30%] h-[30%] rounded-full bg-[#0090C0]/5 blur-[120px]" />
      ...
      <div className="absolute top-20 right-[15%] w-64 h-64 border border-[#0B1E3B]/[0.03] rounded-full rotate-45" />
      <div className="absolute top-24 right-[16%] w-64 h-64 border border-[#0B1E3B]/[0.02] rounded-full" />
    </div>
  );
};
