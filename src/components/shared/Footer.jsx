        ...
        <div className="grid lg:grid-cols-12 gap-16 mb-20">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="https://www.youtube.com/@UndaYouthNetwork" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-slate-50 text-[#00C2CB] hover:bg-[#00C2CB] hover:text-white transition-colors">
                  <Youtube size={18} />
                </a>
                <a href="https://substack.com/@undayouthnetwork" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-slate-50 text-[#00C2CB] hover:bg-[#00C2CB] hover:text-white transition-colors">
                  <Globe size={18} />
                </a>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 grid grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><Link to="/volunteer" className="text-slate-600 hover:text-[#00C2CB] text-sm font-semibold transition-colors">Contribute</Link></li>
