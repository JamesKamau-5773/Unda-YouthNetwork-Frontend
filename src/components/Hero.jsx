...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center bg-unda-bg/50 pt-20 overflow-hidden">
      {/* 1. Background Blurs for Depth (UMV colors) */}
      <div className="absolute inset-0 pointer-events-none" style={{opacity:0.03, backgroundImage: 'radial-gradient(#0B1E3B 1px, transparent 1px)', backgroundSize: '40px 40px'}} />
      <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-[600px] h-[600px] bg-[#00C2CB]/5 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/4 w-[400px] h-[400px] bg-[#00C2CB]/5 rounded-full blur-[100px] pointer-events-none" />

      <div className="container mx-auto px-6 grid lg:grid-cols-12 gap-16 items-center relative z-10">
        {/* Left Content */}
        <div className="lg:col-span-7">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#00C2CB]/10 text-[#0B1E3B] shadow-sm mb-8">
          ...
          <h1 className="text-6xl lg:text-8xl font-extrabold tracking-[-0.05em] leading-[0.9]">
            <span className="block text-[#0B1E3B]">Converse.</span>
            <span className="block text-[#0B1E3B]">Prevent.</span>
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#00C2CB] to-[#0090C0]">Thrive.</span>
          </h1>
          ...
          <p className="mt-8 text-xl text-[#0B1E3B]/70 max-w-lg leading-relaxed font-light">
            ...
            <Button asChild className="h-16 px-10 rounded-2xl bg-[#0B1E3B] text-white hover:bg-[#00C2CB] transition-all shadow-xl shadow-[#0B1E3B]/10">
              <Link to="/membership">
                Join the Network
              </Link>
            </Button>
        ...
        <div className="lg:col-span-5 relative flex flex-col items-center">
          ...
          <div className="absolute -bottom-6 -left-6 z-20 bg-[#0B1E3B] text-white p-6 rounded-3xl shadow-2xl max-w-[180px] animate-bounce-slow">
