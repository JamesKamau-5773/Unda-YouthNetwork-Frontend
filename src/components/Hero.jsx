...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center bg-unda-bg/50 pt-20 overflow-hidden">
      {/* Dynamic Background elements for creativity without fatigue */}
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-12 gap-16 items-center relative z-10">
        ...
        <div className="lg:col-span-7">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-slate-100 shadow-sm mb-8">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Unda Mind Vibes Initiative</span>
          </div>
        ...
        {/* Right Content - Using your Pinterest Image */}
        <div className="lg:col-span-5 relative">
          <div className="relative z-10 rounded-[2.5rem] overflow-hidden shadow-2xl rotate-2 hover:rotate-0 transition-transform duration-700 border-[12px] border-white">
            <img 
              src="https://i.pinimg.com/736x/ac/34/0f/ac340f495ae1469a2dec12f6232045a3.jpg" 
              alt="Young Kenyan people in a supportive peer conversation" 
              className="w-full h-[550px] object-cover" 
            />
          </div>
          
          {/* Floating Impact Tag to add depth */}
          <div className="absolute -bottom-6 -left-6 z-20 bg-unda-navy text-white p-6 rounded-3xl shadow-2xl max-w-[180px] animate-bounce-slow">
            <p className="text-[10px] font-bold text-unda-yellow uppercase mb-1 tracking-widest">Live Pilot</p>
            <p className="text-2xl font-black italic">Nairobi & Coast</p>
          </div>
          
          {/* Decorative Teal circle behind the image */}
          <div className="absolute -top-10 -right-10 w-32 h-32 bg-unda-teal/20 rounded-full -z-10 blur-2xl" />
        </div>
      </div>
    </section>
  );
