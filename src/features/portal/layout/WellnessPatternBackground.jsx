...
const WellnessPatternBackground = () => {
  return (
    <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
      ...
      <svg className="absolute top-6 left-6 w-64 h-64 text-[#00C2CB] opacity-5 blur-xl" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <svg className="absolute top-8 right-8 w-56 h-56 text-[#0090C0] opacity-5 blur-xl rotate-6" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <g fill="currentColor">
      ...
      <svg className="absolute bottom-8 left-8 w-72 h-72 text-[#0090C0] opacity-5 blur-xl -rotate-6" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <svg className="absolute bottom-6 right-6 w-48 h-48 text-[#00C2CB] opacity-5 blur-xl rotate-12" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <g stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none">
