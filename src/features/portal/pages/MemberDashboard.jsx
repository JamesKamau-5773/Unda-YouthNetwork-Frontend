  ...
  return (
    ...
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Wellness Streak */}
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:border-[#00C2CB]/30 hover:shadow-md transition-all group">
        ...
        <div className="grid lg:grid-cols-3 gap-6 h-full">
            ...
            <div className="lg:col-span-2 bg-gradient-to-br from-[#0F172A] to-[#1E293B] rounded-2xl p-8 text-white shadow-xl shadow-slate-200/50 flex flex-col justify-center relative overflow-hidden">
               <div className="absolute top-0 right-0 w-80 h-80 bg-[#00C2CB]/10 rounded-full blur-[100px] pointer-events-none" />
               ...
               <div className="relative z-10">
                  ...
                  <div className="flex gap-4">
                     <Button asChild className="bg-[#00C2CB] text-white hover:bg-[#0090C0] border-0 rounded-xl h-12 px-6 font-bold shadow-lg shadow-[#0090C0]/20">
